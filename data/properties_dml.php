...
function properties_form($selectedId = '', $allowUpdate = true, $allowInsert = true, $allowDelete = true, $separateDV = true, $templateDV = '', $templateDVP = '') {
	...
	$allowUpdate = $hasSelectedId && check_record_permission('properties', $selectedId, 'edit');
	$allowDelete = $hasSelectedId && check_record_permission('properties', $selectedId, 'delete');
	...
	if($hasSelectedId && !check_record_permission('properties', $selectedId, 'view'))
	...
	if($hasSelectedId) {
		$res = sql("SELECT * FROM `properties` WHERE `id`='" . makeSafe($selectedId) . "'", $eo);
	...
	if($hasSelectedId) {
		$jdata = get_joined_record('properties', $selectedId);
	...
	if(function_exists('properties_dv')) {
		$args = [];
		properties_dv(($hasSelectedId ? $selectedId : FALSE), getMemberInfo(), $templateCode, $args);
	}
