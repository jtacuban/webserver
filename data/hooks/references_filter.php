...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="references_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/application_from_storage.png"> 					References Filters</a>
			</h1></div>
