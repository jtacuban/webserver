...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="employment_and_income_history_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/cash_stack.png"> 					Employment and income history Filters</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Tenant</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Tenant</label></div>
			...
			if ($j("#filterfield_2").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "employment_and_income_history",                //table name
						f: "tenant"               //field name
					}
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Employer name</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Employer name</label></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Occupation</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Occupation</label></div>
