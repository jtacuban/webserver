...
<?php }else{ ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="residence_and_rental_history_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/document_comment_above.png"> 					Residence and rental history Filters</a>
			</h1></div>
			...
			if ($j("#filterfield_2").val().length){
				...
				$j.ajax({
					...
					data: {
						...
						p: 1,                                         //page number
						t: "residence_and_rental_history",                //table name
						f: "tenant"               //field name
					}
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;" >
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Reason for leaving</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Reason for leaving</label></div>
		
				
		<input type="hidden" name="FilterAnd[2]" value="and">
		<input type="hidden" name="FilterField[2]" value="9">  
